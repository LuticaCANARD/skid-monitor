...
4. full VRM animation과 rich 3D 연출은 client의 Unity binding 책임으로 둔다. 단, 운영 상태를 보여주는
   제한된 native high-spec 정적 VRM viewport는 [RFC 0003](0003-vrm-avatar-presenter.md)에 따라 egui
   frontend 안에 격리할 수 있다.
