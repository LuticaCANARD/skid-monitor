...
| `skid-monitor-ingress` | Deployment + Service | OIDC agent JWT를 검증하고 OTLP를 PostgreSQL에 commit |
...
Cloud split mode의 PostgreSQL/OIDC, TLS, RLS role, 환경변수와 stream-ticket 설정은
